...
export function getDefaultSystemLedgers(companyId: string, now: number): Omit<Ledger, "updatedAt">[] {
  return [
    ...
    {
      id: `led_${companyId}_purchase`,
      companyId,
      name: "Purchases / Cost of Goods",
      code: "PURCHASE",
      groupId: "grp_direct_expenses",
      groupNature: "expense",
      openingBalance: 0,
      openingBalanceType: "dr",
      currentBalance: 0,
    ...
    {
      id: `led_${companyId}_output_gst`,
      companyId,
      name: "Output GST Payable",
      code: "OUTPUT-GST",
      groupId: "grp_duties_taxes",
    ...
    {
      id: `led_${companyId}_advance_gst_adjustment`,
      companyId,
      name: "Advance GST Adjustment",
      code: "ADV-GST-ADJ",
      groupId: "grp_duties_taxes",
      groupNature: "liability",
      openingBalance: 0,
